...
export const metadata = {
  title: "Nexus Elektrotechniek Rotterdam — Elektra, Zonnepanelen, Airco & Isolatie",
  description: "Nexus Elektrotechniek is uw gecertificeerde installateur in Rotterdam voor elektra, groepenkast vervanging, zonnepanelen, airco en isolatie. Transparante offerte, vakkundige uitvoering.",
};
